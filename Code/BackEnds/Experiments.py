...
try:
    import pyMeasure.Code.BackEnds.Instruments
...
##        self.current_state.save()
        ...
        self.measurement_data=pyMeasure.Code.DataHandlers.Measurements.DataTable(**self.data_dictionary)

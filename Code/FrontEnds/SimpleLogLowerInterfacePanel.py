...
try: 
    ...
    raise
try:
    import pyMeasure.Code.DataHandlers.Logs as Logs
except:
    print """This module requires  pyMeasure.Code.DataHandlers.Logs to operate properly,
...
class SimpleLogLowerInterfacePanel(wx.Panel):
    ...
    def _init_ctrls(self, prnt):
        ...
        self.PreviousEntryButton = wx.BitmapButton(bitmap=wx.Bitmap(str(os.path.join(PYMEASURE_ROOT,'Settings/Images/Previous.png')),
              wx.BITMAP_TYPE_PNG),
        ...
        self.NextEntryButton = wx.BitmapButton(bitmap=wx.Bitmap(str(os.path.join(PYMEASURE_ROOT,'Settings/Images/Next.png')),
              wx.BITMAP_TYPE_PNG),
        ...
        self.IdLabel = wx.StaticText(id=wxID_SIMPLELOGLOWERINTERFACEPANELIDLABEL,
        ...
        self.IdControl = wx.TextCtrl(id=wxID_SIMPLELOGLOWERINTERFACEPANELIDCONTROL,
    ...
    def OnOpenButtonButton(self, event):
        ...
        try:
            if dlg.ShowModal() == wx.ID_OK:
                ...
                self.current_log=Logs.Log(filename)
        finally:
            dlg.Destroy()
        try:

...
#
# Created:     2009/09/09
# RCS-ID:      $Id: GetMetadata.py $
# Copyright:   (c) 2009
# Licence:     GPL
#-----------------------------------------------------------------------------
""" This module gets metadata on files from the filesytem (Windows only) or
the file itself."""
...
#-------------------------------------------------------------------------------
# Script Functions
def test_get_metadata(test_path=\
    """C:\Documents and Settings\sandersa\My Documents\Share\python\MyPrograms\Examples\Evil Plan.ppt"""):
    """ Script to test the metadata function """
    
    print 'The Test Path is: %s'%test_path
    print '-'*80
    
    for key,value in get_metadata(test_path).iteritems():
        print '%s : %s'%(key,value)
        
def test_get_python_metadata():
    MD=get_python_metadata(r'C:\Documents and Settings\sandersa\My Documents\Share\ArbDB\arbDB.py')
...
if __name__ == '__main__':
    a=get_image_metadata(r'F:\Share\PIF Scientific Team\3DEM\04232013 GA3 RNC\Grid A3 RNC_034.tif')
    print a